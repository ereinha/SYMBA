...
def format_other_subscripts(var, subscript):
    ...
    idxs = subscript.split(",")
    idxs = [format_index(idx) for idx in idxs]
    # ind1 = format_index(ind1)
    # ind2 = format_index(ind2)
